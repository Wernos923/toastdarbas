...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CheckBox cbRememberMe = (CheckBox) findViewById(R.id.Remember_me);
            ...
            public void onClick(View view) {
                ...
                if (!cancel) {
                    Toast.makeText(LoginActivity.this,
                            "Prisijungimo vardas: " + etUsername.getText().toString(), Toast.LENGTH_SHORT).show();
                    ...
                    Intent goToSearchActivity = new Intent(LoginActivity.this, MainActivity.class);
